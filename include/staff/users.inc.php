...
<thead>
        <tr>
            ...
            <th width="22%"><a class="text-decoration-none text-dark" <?php echo $status_sort; ?> href="users.php?<?php
                echo $qstr; ?>&sort=status"><?php echo __('Status'); ?></a></th>
            <th width="20%"><a class="text-decoration-none text-dark" <?php echo $create_sort; ?> href="users.php?<?php
                echo $qstr; ?>&sort=create"><?php echo __('Created'); ?></a></th>
            <th width="20%"><a class="text-decoration-none text-dark" <?php echo $update_sort; ?> href="users.php?<?php
