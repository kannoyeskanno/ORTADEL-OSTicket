...
<div id="basic_search">
    <div style="min-height:25px;">
        <form action="users.php" method="get">
            ...
            <input type="text" class="form-control" value="<?php echo Format::htmlchars($_REQUEST['query']); ?>" placeholder="Search..." aria-label="Username" aria-describedby="addon-wrapping" name="query"
